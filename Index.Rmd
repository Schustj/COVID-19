...
covid19Data <- myData2 %>% select(`Data as of`, `State`, `COVID19 Deaths`) %>% filter(State %in% c("Michigan", "Ohio", "Wisconsin", "Minnesota", "Illinois", "Indiana", "Kentucky") & !is.na(`COVID19 Deaths`))
...
covid19Data2 <- myData2 %>% select(`Data as of`, `State`, `COVID19 Deaths`) %>% filter(State %in% c("New Jersey", "Georgia", "Maryland", "Colorado", "Pennsylvania", "Tennessee", "Louisiana") & !is.na(`COVID19 Deaths`))

...
ggplot(covid19Data, aes(State, Deaths)) + geom_bar() + labs(title = "Midwest Coalition States COVID deaths", x = "State", y = "Deaths") + coord_flip()
...
ggplot(covid19Data2) + geom_bar(aes()) + labs(title = "Midwest Coalition States COVID deaths", x = "State", y = "Deaths")

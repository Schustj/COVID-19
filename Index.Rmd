...
ggplot(covid19Data, aes(State, Deaths)) + geom_col() + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + labs(title = "Midwest Coalition States COVID deaths", x = "State", y = "Deaths")
...
ggplot(covid19Data2, aes(State, Deaths)) + geom_col() + labs(title = "Similar Population States COVID deaths", x = "State", y = "Deaths")
